...
import { getPaidClaimsByStaff } from "@/lib/redux/reducers/claims.reducer";
...
const ClaimsPaid = () => {
  ...
  useEffect(() => {
    dispatch(getPaidClaimsByStaff(userData.id));
  }, []);
...
export default withAuthorization(ClaimsPaid, allowedRoles);
