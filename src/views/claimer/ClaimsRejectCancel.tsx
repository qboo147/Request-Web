...
import { getRejectedCancelledClaimsByStaff } from "@/lib/redux/reducers/claims.reducer";
...
const ClaimsRejectCancel = () => {
  ...
  useEffect(() => {
    dispatch(getRejectedCancelledClaimsByStaff(userData.id));
  }, []);
...
export default withAuthorization(ClaimsRejectCancel, allowedRoles);
