...
import { getApprovedClaimsByStaff } from "@/lib/redux/reducers/claims.reducer";
...
const ClaimsApproved = () => {
  ...
  useEffect(() => {
    dispatch(getApprovedClaimsByStaff(userData.id));
  }, []);
...
export default withAuthorization(ClaimsApproved, allowedRoles);
